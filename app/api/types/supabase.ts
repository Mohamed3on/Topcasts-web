  ...
  public: {
    ...
    Functions: {
      calculate_episode_metrics:
        | {
            Args: { end_date: string; episode_id: number; start_date: string }
            Returns: {
              dislikes: number
              likes: number
        ...
        | {
            Args: { end_date: string; p_episode_id: number; start_date: string }
            Returns: {
              dislikes: number
              likes: number
              popularity_score: number
      ...
      upsert_podcast: { Args: { p: Json }; Returns: number }
    }
    Enums: {
      [_ in never]: never
    }
