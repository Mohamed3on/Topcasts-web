...
const Header = async () => {
  ...
  return (
    <header className="bg-background-header/95 supports-[backdrop-filter]:bg-background-header/60 sticky  top-0 z-10 mb-8 flex w-full items-center justify-between border-b px-4 py-2 shadow-sm backdrop-blur">
